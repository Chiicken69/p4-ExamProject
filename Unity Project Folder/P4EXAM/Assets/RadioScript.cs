...
public class RadioScript : MonoBehaviour
{
  ...
  private Queue<DialogEntry> dialogData = new Queue<DialogEntry>();
    ...
    void DialogController()
    {
        ...
        if (timeInSeconds >= 60 && !triggeredTimes.Contains(6))
        {
